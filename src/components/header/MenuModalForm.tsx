...
const onePages = dataGlobal.widgets.onePages;
  ...
  return (
    <div>
      ...
      {
        openModal && (
          <div className={`fixed top-0 right-0 z-50 ${onePages ? 'w-full md:w-[30%]' : 'w-[30%]'}  h-full bg-gray-900 bg-opacity-50 flex items-center justify-end ${animateMenu}`}>
            <div className="bg-black text-white w-full h-full rounded-l shadow-lg p-4 overflow-y-auto">
              <div className="flex justify-end items-center mb-4">
                <button
                  className="text-red-500 text-3xl hover:text-gray-700"
              ...
              <ContactForm dataGlobal={dataGlobal} formStyles="bg-black shadow-sm rounded-t-0 rounded-b-xl md:rounded-xl p-5" />
